...
public class ModItems {
    ...
    //TODO figure out how to register sets of things easier (armor/tools) while still having access to them in other classes
    ...
    public static final DeferredItem<Item> RADISH = ITEMS.register("radish",
            () -> new Item(new Item.Properties().food(ModFoodProperties.RADISH)) {
                ...
                public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
                    tooltipComponents.add(Component.translatable("tooltip.michaelsamazingtestmod.radish.tooltip"));
