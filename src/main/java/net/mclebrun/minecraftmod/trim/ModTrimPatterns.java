package net.mclebrun.minecraftmod.trim;
...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> MICHAEL = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(MinecraftMod.MOD_ID, "michael"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.MICHAEL_SMITHING_TEMPLATE, MICHAEL);
    }
